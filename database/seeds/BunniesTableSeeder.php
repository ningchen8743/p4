...
class BunniesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $bunnies = [
            ...
            ['Hector', 'buck', '2018-4-23', 'Jersey Wooly', 'adoptable','https://rabbit.org/articles/wp-content/uploads/2018/01/Hector-Gene-225x300.jpg'],
            ...
            ['Ellie', 'buck', '2016-08-08', 'Angora', 'adoptable','https://rabbit.org/articles/wp-content/uploads/2016/02/Ellie-2-300x224.jpg'],
            ['Max', 'buck', '2015-10-01', 'Lionhead', 'adoptable','https://rabbit.org/articles/wp-content/uploads/2014/10/Max-2.jpg'],
            ['Guimauve', 'buck', '2016-02-07', 'Angora', 'adoptable','https://rabbit.org/articles/wp-content/uploads/2014/08/Guimauve-300x287.jpg'],
        ];
